...
//       //   key={index} 
//       // >
//       //   <div className="main_content w-full flex justify-center items-center flex-col">
...
//       //     </div>
//       //   </div>
//       //   <div className="button_slide w-full h-full flex gap-2 justify-center items-center ">
//       //     <button className="bg-slate-900 text-white font-bold py-2 px-4 rounded-lg">Branch</button>
//       //     <button className="bg-slate-900 text-white font-bold py-2 px-4 rounded-lg">Session</button>
//       //   </div>
//       //   </div>
//       <div
//       className="shadow-md hover:bg-slate-100 flex flex-col justify-center items-center w-full p-5 gap-0 font-bold rounded-sm"
...
//     >
//       <div
//         className={`main_content w-full flex justify-center items-center flex-col ${isActive ? "hidden" : ""}`}
...
//         </div>
//       </div>
//       <div className={`button_slide w-full h-28 flex gap-2 justify-center items-center ${isActive ? "active" : ""}`} onClick={() => setIsActive(false)}>
//         <button className="bg-slate-900 text-white font-bold py-2 px-4 rounded-lg">Branch</button>
//         <button className="bg-slate-900 text-white font-bold py-2 px-4 rounded-lg">Session</button>
//       </div>
//     </div>
